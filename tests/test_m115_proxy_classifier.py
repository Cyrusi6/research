...
def test_trial_spec_v5_freezes_policy_and_proxy_start_binds_runtime_identity(tmp_path) -> None:
    ...
    assert trial_spec["schema_version"] == "auto_research_trial_spec_v5"
    ...
    assert manifest["schema_version"] == "auto_research_phase_execution_manifest_v2"
